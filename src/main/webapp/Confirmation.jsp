...
<%
    ...
    //PackageEntity pack= (PackageEntity) session.getAttribute("chosenPack");
%>
    ...
    <div class="col-md-5">
        ...
        <div class="bg-light text-dark">
            ...
            <div class="p-2 d-flex flex-row justify-content-between">
                <p class="">Pacchetto:</p>
                <p>nome del pacchetto</p>
                <p>prezzo</p>
            </div>
            <% if (session.getAttribute("chosenOpt")!=null){
            %>
            <hr class="my-1"/>
            ...
            <div class="p-2 d-flex flex-row justify-content-between">
                <p>Periodo:</p>
                <p><%=session.getAttribute("chosenMonths")%>></p>
                <p>sconto</p>
            </div>
            <div class="p-2 d-flex flex-row justify-content-between">
                <p>Totale:</p>
